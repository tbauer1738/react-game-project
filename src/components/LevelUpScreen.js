    ...
    case 1:
       return <div className="App">
        ...
        {this.state.rewardsL2.map(reward => {
         return <div onClick={() => this.handleSelectedAbility(reward.name, reward.damage)}>{reward.name}  which does {reward.damage} damage</div>
        })}
      </div>
    case 3: 
        return <div className="App">
        <div>You've vanquished all the evil in this dungeon...  for now...</div>
        </div>
